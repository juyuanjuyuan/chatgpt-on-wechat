...
- 原有 Web Console 已集成 Recruit Dashboard 视图（无需单独进入 Next.js 页面即可操作）。
...
- Dashboard(独立 Next.js，可选): `http://localhost:3000`
- Web Console(内置 Recruit Dashboard): `http://localhost:9899/chat`
